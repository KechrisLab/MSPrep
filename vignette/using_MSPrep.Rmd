...
author: 
    - name: Matt Mulvahill
      ...
      affiliation: Product Intelligence @ Charter Communications
    - name: Grant Hughes
    ...
    - name: Katerina Kechris
      ...
      affiliation: University of Colorado Anschutz Medical Cam
package: MSPrep
output: 
...
- an explanation what each of the functions does
